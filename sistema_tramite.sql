...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2024 a las 15:14:39
...
-- Procedimientos
--
CREATE PROCEDURE `SP_CARGAR_DNI_UL` (IN `ID` INT)   SELECT
	usuario.usu_id, 
...
CREATE PROCEDURE `SP_CARGAR_EXPEDIENTE` (IN `ID` INT)   BEGIN
DECLARE IDAREA INT;
...
CREATE PROCEDURE `SP_CARGAR_SELECT_AREA_SOLO` ()   SELECT
...
CREATE PROCEDURE `SP_CARGAR_SELECT_TIPO` ()   SELECT
...
CREATE PROCEDURE `SP_CARGAR_TICKET` (IN `NUMERO` VARCHAR(12))   SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente),
	MONTHNAME(documento.doc_fecharegistro) AS FECHA,
...
CREATE PROCEDURE `SP_ELIMINAR_TRAMITE` (IN `ID` CHAR(12))   BEGIN
...
CREATE PROCEDURE `SP_LISTAR_HORA` ()   SELECT
	id_horario,
	hora_inicio, 
	hora_fin, 
	usuario.usu_id, 
...
CREATE PROCEDURE `SP_LISTAR_TIPO_DOCUMENTO` ()   SELECT
	tipo_documento.tipodocumento_id, 
	tipo_documento.tipodo_descripcion, 
...
CREATE PROCEDURE `SP_LISTAR_TOTAL_DOC ACPETADO` (IN `AREA` INT, IN `TIPOUSU` VARCHAR(255))   BEGIN
SET @ROL:=TIPOUSU;
...
CREATE PROCEDURE `SP_LISTAR_TRAE_REQUISITO` (IN `ID` INT)   SELECT 
	tipo_documento.tipodo_descripcion,
	tipo_documento.requisitos
FROM
	tipo_documento
...
CREATE PROCEDURE `SP_LISTAR_TRAE_REQUISITO_DNI` (IN `DNI` CHAR(12))   SELECT
	empleado.empleado_id,
	empleado.emple_nrodocumento, 	
	empleado.emple_nombre, 
	empleado.emple_apepat, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE` ()   SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
	documento.doc_nombreremitente, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA` (IN `IDUSUARIO` INT)   BEGIN
DECLARE IDAREA INT;
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA2` (IN `IDAREA` INT)   SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
	documento.doc_nombreremitente, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_BUSCAR` (IN `IDAREA` INT, IN `ESTADO` VARCHAR(20))   SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
	documento.doc_nombreremitente, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_ESTADO` (IN `FINICIO` DATETIME, IN `FFIN` DATETIME, IN `ESTADO` VARCHAR(20))   BEGIN
SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_ESTADO_TA` (IN `FINICIO` DATETIME, IN `FFIN` DATETIME, IN `ESTADO` VARCHAR(20), IN `IDAREA` INT)   BEGIN
SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_FECHAS` (IN `FINICIO` DATETIME, IN `FFIN` DATETIME, IN `IDAREA` INT)   BEGIN
SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_FECHAS_TA` (IN `FINICIO` DATETIME, IN `FFIN` DATETIME, IN `IDAREA` INT)   BEGIN
SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_TIPO_DOC` (IN `FINICIO` DATETIME, IN `FFIN` DATETIME, IN `TIPO` INT)   BEGIN
SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_AREA_TIPO_DOC_TA` (IN `FINICIO` DATETIME, IN `FFIN` DATETIME, IN `TIPO_DOC` INT, IN `IDAREA` INT)   BEGIN
SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_ESTADO` (IN `ESTADO` VARCHAR(20))   SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
	documento.doc_nombreremitente, 
...
CREATE PROCEDURE `SP_LISTAR_TRAMITE_SEGUIMIENTO` (IN `ID` CHAR(12))   SELECT
	movimiento.movimiento_id, 
	movimiento.documento_id, 
...
CREATE PROCEDURE `SP_MODIFICAR_COMUNICADO` (IN `ID` INT, IN `TITULO` VARCHAR(255), IN `DESCRIPCION` TEXT, IN `ENLACE` VARCHAR(255))   UPDATE comunicados SET
titulo=TITULO,
descripcion=DESCRIPCION,
enlace=ENLACE
WHERE id_comunicado=ID$$

CREATE PROCEDURE `SP_MODIFICAR_EMPLEADO` (IN `ID` INT, IN `NDOCUMENTO` CHAR(12), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `FECHA` DATE, IN `MOVIL` CHAR(9), IN `MODALIDAD` VARCHAR(255), IN `DIRECCION` VARCHAR(255), IN `EMAIL` VARCHAR(255), IN `ESTADO` VARCHAR(20))   BEGIN
...
CREATE PROCEDURE `SP_MODIFICAR_HORARIO` (IN `ID` INT, IN `HORAINICIO` VARCHAR(20), IN `HORAFIN` VARCHAR(20))   UPDATE horario SET
hora_inicio=HORAINICIO, hora_fin=HORAFIN
where id_horario=ID$$

CREATE PROCEDURE `SP_MODIFICAR_TIPO_DOCUMENTO` (IN `ID` INT, IN `NTIPO` VARCHAR(255), IN `ESTADO` VARCHAR(20), IN `REQUISITOS` VARCHAR(255))   BEGIN
...
CREATE PROCEDURE `SP_MODIFICAR_TRAMITE_ESTATUS` (IN `ID` INT, IN `ESTATUS` VARCHAR(50))   UPDATE documento SET
documento.doc_estatus=ESTATUS,
documento.dias_pasados=''
WHERE documento.doc_nrodocumento=ID$$

CREATE PROCEDURE `SP_MODIFICAR_USUARIO` (IN `ID` VARCHAR(255), IN `IDEMPLEADO` INT, IN `IDAREA` INT, IN `ROL` VARCHAR(25))   UPDATE usuario SET
...
CREATE PROCEDURE `SP_RECHAZAR_TRAMITE` (IN `ID` CHAR(12), IN `DESCRIPCION` VARCHAR(255), IN `LOCAL1` INT)   BEGIN
...
CREATE PROCEDURE `SP_REGISTRAR_COMUNICADOS` (IN `TITULO` VARCHAR(255), IN `DESCRIPCION` TEXT, IN `IDUSU` INT, IN `ENLACE` VARCHAR(255))   BEGIN
DECLARE ID INT;
...
CREATE PROCEDURE `SP_REGISTRAR_EMPLEADO` (IN `NDOCUMENTO` CHAR(12), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `FECHA` DATE, IN `MOVIL` CHAR(9), `MODALIDAD` VARCHAR(255), IN `DIRECCION` VARCHAR(255), IN `EMAIL` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM empleado WHERE emple_nrodocumento=NDOCUMENTO);
IF @CANTIDAD=0 THEN
...
CREATE PROCEDURE `SP_REGISTRAR_TIPO_DOCUMENTO` (IN `TIPODOC` VARCHAR(255), IN `REQUISITOS` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
...
CREATE PROCEDURE `SP_REGISTRAR_TRAMITE_DERIVAR` (IN `ID` CHAR(15), IN `ORIGEN` INT, IN `DESTINO` INT, IN `DESCRIPCION` VARCHAR(255), IN `IDUSUARIO` INT, IN `RUTA` VARCHAR(255), IN `TIPO` VARCHAR(255), IN `ACCION` VARCHAR(255))   BEGIN
...
CREATE PROCEDURE `SP_REGISTRAR_TRAMITE_UL` (IN `DNI` CHAR(8), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(50), IN `APEMAT` VARCHAR(50), IN `CEL` CHAR(9), IN `EMAIL` VARCHAR(150), IN `DIRECCION` VARCHAR(255), IN `REPRESENTACION` VARCHAR(50), IN `RUC` CHAR(12), IN `RAZON` VARCHAR(255), IN `AREAPRINCIPAL` INT, IN `AREADESTINO` INT, IN `TIPO` INT, IN `NRODOCUMENTO` VARCHAR(15), IN `ASUNTO` VARCHAR(255), IN `RUTA` VARCHAR(255), IN `FOLIO` INT, IN `IDUSUARIO` INT, IN `ACCION` VARCHAR(255), IN `OBSERVA` VARCHAR(255), IN `RESPU` INT)   BEGIN
DECLARE cantidad INT;
DECLARE cod char(12);
SET @cantidad :=(SELECT IFNULL(MAX(doc_ncorrelativo),0) FROM documento );
IF @cantidad >= 1 AND @cantidad <= 8 THEN
...
CREATE PROCEDURE `SP_TOTAL_DOCUMENTOS_ACEPTADOS` ()   SELECT count(documento_id)as totaldocpen FROM documento where doc_estatus="ACEPTADO"$$

CREATE PROCEDURE `SP_TOTAL_DOCUMENTOS_ACEPTADOS_AREA` (IN `IDAREA` INT)   SELECT count(*)as totaldocpend FROM documento where doc_estatus="PENDIENTE" and area_origen=IDAREA$$

CREATE PROCEDURE `SP_TOTAL_DOCUMENTOS_FINALIZADO` ()   SELECT count(documento_id)as totaldocpen FROM documento where doc_estatus="FINALIZADO"$$

CREATE PROCEDURE `SP_TOTAL_DOCUMENTOS_PENDIENTES2` (IN `IDUSUARIO` INT)   BEGIN
DECLARE IDAREA INT;
SET @IDAREA :=(SELECT area_id FROM usuario WHERE usu_id=IDUSUARIO);
SELECT
...
CREATE PROCEDURE `SP_TRAER_DATOS` ()   SELECT 
id_horario,
hora_inicio,
hora_fin
...
CREATE PROCEDURE `SP_TRAER_DATOS2` (IN `ID` INT)   SELECT id_horario,hora_inicio,hora_fin
FROM horario
WHERE id_horario=ID$$

CREATE PROCEDURE `SP_TRAER_DATOS_EXPEDIENTE` (IN `ID` CHAR(12))   SELECT
	documento.documento_id,
	documento.doc_dniremitente,
	documento.doc_nombreremitente,
	documento.doc_apepatremitente,
...
CREATE PROCEDURE `SP_TRAER_DATOS_EXPEDIENTE_ADMIN` ()   SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
	documento.doc_nombreremitente, 
...
CREATE PROCEDURE `SP_TRAER_WIDGET` (IN `IDAREA` INT)   SELECT
...
CREATE PROCEDURE `SP_VERIFICAR_USUARIO` (IN `USU` VARCHAR(255))   SELECT
	usuario.usu_id, 
	usuario.usu_usuario, 
	usuario.usu_contra, 
	usuario.usu_feccreacion, 
...
CREATE TABLE `documento` (
  ...
  `doc_estatus` enum('PENDIENTE','RECHAZADO','ACEPTADO','FINALIZADO','SIN RESPUESTA') NOT NULL,
...
('D0000018', '26626266', 'ANDREA', 'SANCHEZ', 'JIMENEZ', '966226262', 'andrea12@gmail.com', 'AV. DIAZ BARCENAS N° 323', 'A NOMBRE PROPIO', '', '', 2, '233', 23, 'DSF', 'controller/tramite/documentos/ARCH21-11-2024-7-663.PDF', '2024-11-21 07:33:39', 1, 'RECHAZADO', 1, 5, 18, 0, NULL, '-1. ACCIÓN--2. TRAMITAR-ONON', '', 2),
('D0000019', '26626266', 'ANDREA', 'SANCHEZ', 'JIMENEZ', '966226262', 'andrea12@gmail.com', 'AV. DIAZ BARCENAS N° 323', 'A NOMBRE PROPIO', '', '', 2, '323', 2, 'VERIFICAR', 'controller/tramite/documentos/ARCH21-11-2024-8-661.PDF', '2024-11-21 08:51:52', 1, 'PENDIENTE', 3, 1, 19, 0, NULL, '-1. ACCIÓN--2. TRAMITAR-ONON', '', 1);
...
(9, 'PEDRO', 'JIMENEZ', 'SANCHEZ', '2023-10-22', '1980-08-14', '51151515', '915151551', 'CAS', 'pedro3@gmail.com', 'ACTIVO', 'AV. CANADA S/N', 'controller/empleado/FOTOS/IMG21-11-2024-7-306.jpg'),
(10, 'JOSUE', 'SANCHEZ', 'PERALTA', '2023-10-22', '1990-01-15', '65611661', '915615515', 'Funcionario', 'josue21@gmail.com', 'ACTIVO', 'JR. CUSCO N° 455', 'controller/empleado/FOTOS/IMG21-11-2024-7-162.jpg');
...
(2, 'DIRESA ABANCAY', 'DIRESA123@GMAIL.COM', '14521', '952652145', 'AV. DANIEL ALCIDES CARRION S/N ABANCAY APURíMAC', 'controller/empresa/FOTOS/IMG21-11-2024-9-404.png');
...
(46, 'D0000018', 1, 5, '2024-11-21 07:33:39', 'FALTA DOCUMENTOS', 'RECHAZADO', 2, 'controller/tramite/documentos/ARCH21-11-2024-7-663.PDF', NULL, '-1. ACCIÓN--2. TRAMITAR-ONON'),
(47, 'D0000019', 3, 1, '2024-11-21 08:51:52', 'VERIFICAR', 'PENDIENTE', 2, 'controller/tramite/documentos/ARCH21-11-2024-8-661.PDF', NULL, '-1. ACCIÓN--2. TRAMITAR-ONON');
...
--
ALTER TABLE `movimiento`
  MODIFY `movimiento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
