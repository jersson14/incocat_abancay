...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><b>MANTENIMIENTO DE EXPEDIENTES POR FECHA Y DISTRITO</b></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="row" style="border: 1px solid #ccc; padding: 15px; border-radius: 8px;">
                                ...
                                <div class="col-2 form-group">
                                    ...
                                    <select class="form-control" id="select_depar_buscar3" style="width:100%">
                                    </select>
                                </div>
                                <div class="col-2 form-group">
                                    <label for="">Provincia:</label>
                                    <select class="form-control" id="select_provincia_buscar3" style="width:100%">
                                    </select>
                                </div>
                                <div class="col-2 form-group">
                                    <label for="">Distrito:</label>
                                    <select class="js-example-basic-single" id="select_distrito_buscar3" style="width:100%">
                                    </select>
                                </div>
                                <div class="col-12 col-md-2" role="document">
                                    <label for="">&nbsp;</label><br>
                                    <button onclick="listar_expedientes_filtro_distrito()" class="btn btn-danger mr-2" style="width:100%" onclick><i class="fas fa-search mr-1"></i>Buscar expedientes</button>
                                </div>
