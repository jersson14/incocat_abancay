<?php
    ...
    class Modelo_Empleado extends conexionBD{
        ...
        public function Registrar_Empleado($nro,$nom,$apepa,$apema,$fnac,$movil,$modalidad,$dire,$email){
            $c = conexionBD::conexionPDO();
        ...
        public function Modificar_Empleado($id,$nro,$nom,$apepa,$apema,$fnac,$movil,$modalidad,$dire,$email,$esta){
            $c = conexionBD::conexionPDO();
