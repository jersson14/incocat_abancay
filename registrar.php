  ...
  <!-- Content Wrapper. Contains page content -->
            ...
            <div class="container">
                <div class="row mb-2">
                    <div class="col-sm-12" style="text-align:center;color:#3E445E">
                        <h4 class="m-0"><b>INDUSTRIA DE LA CONSTRUCCION CAT S.R.L.</b></h4>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
    ...
    <!-- Main content -->
        ...
        <div class="background-container">
            ...
            <hr>
            <p style="font-size:13.5px;text-align:justify"><b>La Empresa INCOCAT pone a su disposición la MESA DE PARTES VIRTUAL, para la recepción de documentos y solicitudes. Los documentos serán atendidos y recepcionados de Lunes a Viernes en el horario de 8:00am a 5:00pm. Es obligatorio registrar su correo electrónico, para dar respuesta a su solicitud.</b></p>
            <hr>
                <div class="row">
                <div class="col-12">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                <label for="" >Tipo Trámite(*):</label>
                                <select class="js-example-basic-single" id="select_tipo" style="width:100%"></select>
                            </div>
                            <div class="col-12 form-group">
                                <label for="" >Costo del trámite(*):</label>
                                <input type="text" class="form-control" id="txt_ndocumento" value="S/ 5000.00" onkeypress="return soloNumeros(event)">
                            </div>
                            <div class="col-12 form-group" style="color:red">
                            ...
                            <div class="col-12" style="text-align:center">
                                <button class="btn btn-success btn-lg" onclick="" id="btn_registro"><i class="fas fa-save"></i><b> REGISTRAR TRÁMITE</b></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    background-image: url('img/img3.jpg'); /* Cambia 'ruta/de/tu/imagen.jpg' por la ruta de tu imagen */
...
.image-container {
    ...
    height: 100%; /* Asegúrate de que tenga altura suficiente para centrar */
}
